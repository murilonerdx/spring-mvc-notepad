...
<head>
    ...
    <style>
        <%@include file="./WEB-INF/assets/css/Sidebar-Menu-1.css" %>
    </style>
    <style>
        <%@include file="./WEB-INF/assets/css/Sidebar-Menu.css" %>
    </style>
    <style>
        <%@include file="./WEB-INF/assets/css/NZButtonSaveClose.css" %>
    </style>
    <style>
        <%@include file="./WEB-INF/assets/css/Lista-Productos-Canito.css" %>
    </style>
    ...
    <div class="container">
        <div class="row text-center d-flex justify-content-center align-items-end justify-content-xxl-center align-items-xxl-center">
            <div class="col-md-4 text-center d-flex justify-content-center align-items-end justify-content-xxl-center align-items-xxl-center">
                <h2 class="text-center d-flex justify-content-center align-items-end justify-content-xxl-center align-items-xxl-center"
                    style="width: 343px;">SUAS NOTAS</h2>
            </div>
        </div>
            ...
            <div class="col-md-12 text-center d-flex justify-content-center align-items-end justify-content-xxl-center align-items-xxl-center">
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <c:forEach items="${notas}" var="item">
                        <tr>
                            <td name="id"><c:out value="${item.id}"/></td>
                            <td name="titulo"><c:out value="${item.titulo}"/></td>
                            <td name="assunto"><c:out value="${item.assunto}"/></td>
                            <form action="mostrar-notas" method="post">
                            <td>
                                <input name="isWhat" value="${item.id}" hidden></input>
                                <button type="submit" name="edit" value="edit" class="btn btn-warning">Editar</button>
...
<
<script>
    <%@include file="WEB-INF/assets/bootstrap/js/bootstrap.min.js" %>
</script>
<script>
    <%@include file="WEB-INF/assets/js/Sidebar-Menu.js" %>
</script>
</body>
